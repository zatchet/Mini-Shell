...
typedef struct vect {char **data; unsigned int size; unsigned int capacity;} vect_t;
...
/**Get a copy of the data array associated with the given vect. */
char **vect_get_data_copy(vect_t *v);
